...
.calendar-grid { display: grid; grid-template-columns: 140px repeat(${dim(activeYear, month)}, 1fr); gap: 0px; width: 100%; min-width: 0; }
...
@media (max-width: 600px) {
  .calendar-grid { grid-template-columns: 110px repeat(${dim(activeYear, month)}, 45px); width: max-content; }
